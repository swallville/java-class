 ...
 * @todo Return
 */
char* map_methods_handle_types(uint8_t);
/**
...
char* map_method_flags(uint16_t);
 ...
 * @todo Return
 */
char* utf8ToString(uint8_t*, uint16_t);
 ...
 * @todo Return
 */
uint32_t getDoubleWord(FILE*, int);
