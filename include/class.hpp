 ...
 * @todo Return
 */
char* getUtf8FromConstantPool(int, ConstPool*);
 ...
 * @todo Return
 */
uint8_t get1bytesFromByteArray(uint8_t*, int);
 ...
 * @todo Return
 */
uint16_t get2bytesFromByteArray(uint8_t*, int);
 ...
 * @todo Return
 */
uint32_t get4bytesFromByteArray(uint8_t*, int);
 ...
 * @todo Return
 */
double decodeDouble (uint32_t, uint32_t);
 ...
 * @todo Return
 */
long decodeLong(uint32_t, uint32_t);
 ...
 * @todo Return
 */
ConstPool* getConstantPool(FILE*, int*, uint16_t);
 ...
 * @todo Return
 */
uint16_t* getInterfaces(FILE*, int*, uint16_t);
 ...
 * @todo Return
 */
Field * getFields(FILE*, int*, uint16_t, ConstPool*);
 ...
 * @todo Return
 */
Method* getMethods(FILE*, int*, uint16_t, ConstPool*);
 ...
 * @todo Return
 */
Attribute* getAttributes(FILE*, int*, uint16_t, ConstPool*);
 ...
 * @todo Return
 */
Attribute* getAttributesFromByteArray(uint8_t*, int*, uint16_t, ConstPool*);
 ...
 * @todo Return
 */
void* decodeInfo(Attribute, ConstPool*);
 ...
 * @todo Return
 */
Bootstrap_methods* getBootstrapMethods(uint8_t*, int*, int);
/**
 * @brief
 * @todo Description
 * @todo Parameters
 * @todo Return
 */
StackMapFrame* getStackMapFrame(uint8_t*, int*, int);
  ...
  * @todo Return
  */
VerificationTypeInfo* getVerificationTypeInfo (uint8_t*, int*);
 ...
 * @todo Return
 */
ExceptionTableEntry* getExceptionTable(uint8_t*, int*, int);
 ...
 * @todo Return
 */
InnerClass* getInnerClasses(uint8_t*, int*, int);
 ...
 * @todo Return
 */
LineNumberTableEntry* getLineNumberTable(uint8_t*, int*, int);
 ...
 * @todo Return
 */
LocalVariableTableEntry* getLocalVariableTable(uint8_t*, int*, int);
